...
def generate_markdown(boj_ids, boj_map, boj_details, swea_data):
    content = "# algorithms \n\n"
    content += f"[![Solved.ac프로필](http://mazassumnida.wtf/api/v2/generate_badge?boj={SOLVED_AC_HANDLE})](https://solved.ac/{SOLVED_AC_HANDLE}) ![mazandi profile](http://mazandi.herokuapp.com/api?handle={SOLVED_AC_HANDLE}&theme=cold)\n\n"
