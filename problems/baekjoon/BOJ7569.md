...
<table width="100%">
  <tr>
    ...
    <td width="30%"><img src="https://img.shields.io/badge/BOJ-0076C0?style=flat-square&logo=baekjoon&logoColor=white"></td>
  </tr>
  <tr>
    <td><b>Category</b></td>
    <td colspan="3">
      <img src="https://img.shields.io/badge/BFS-20C997?style=flat-square">
      <img src="https://img.shields.io/badge/Gold_5-EC9A00?style=flat-square">
    </td>
  </tr>
</table>
...
- 시작 점이 여러 개인 bfs
-  q에 `h`, `r`, `c`, `days` 갖고 다님
-  bfs수행 후 남은 토마토 수에 따라 `days` 또는 `-1` 출력
